...
# libsvg stuff
LIBSVG_EXTRA_SOURCES = libsvg/svg_parser_expat.c libsvg/svg_hash.c libsvg/svg_hash.h
LIBSVG_SOURCES = \
	libsvg/svg.c \
	libsvg/svg.h \
	libsvg/svgint.h \
...
LOCAL_CFLAGS += -DCONFIG_DIR=\"/\" -Ijni/libagg/agg/include/ -Ijni/libagg/agg/gpc/ -Ijni/libagg/aggsvg \
-Ijni/libexpat/ -Ijni/libexpat/expat/ -DHAVE_CONFIG_H -DHAVE_EXPAT_CONFIG_H -Wall -fexceptions
